...
int main(int agrc, char **agrv)
{
  ...
  m1_result.mesg_type = 4;
  m1_result.partial_result = receive_message(ID_QUEUE_MESSAGES_TO_READERS, m1, 2);
  strcpy(m1_result.mesg_text, "2º Result Message");
...
int receive_message(int id_queue_messages, message msg, long msg_type)
{
  ...
  printf("\n\r==================================CALCULANDO O FATORIAL PARCIAL 2===================================\n\r");
